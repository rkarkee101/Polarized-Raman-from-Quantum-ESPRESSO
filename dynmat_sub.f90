...
subroutine RamanIR (nat, omega, w2, z, zstar, eps0, dchi_dtau)
 ...
 logical noraman
 real(DP), allocatable :: infrared(:), raman(:,:,:), infrared_polar(:,:)
 ...
 allocate(infrared_polar(3,3*nat))
 !
 noraman=.true.
 do nu = 1,3*nat
    do ipol=1,3
    ...
    infrared_polar(1:3,nu) = 2.d0*(polar(1:3)**2)*irfac
    !
    do ipol=1,3
       do jpol=1,3
 ...
 do nu = 1,3*nat
    ...
    if (noraman) then
       ...
       write (6,'(a,3f10.4)') "IR xyz: ", infrared_polar(1:3,nu)
       write (6,'(a,3f15.4)') "Raman x: ", raman(1,1,nu), raman(1,2,nu),raman(1,3,nu)
       write (6,'(a,3f15.4)') "Raman y: ", raman(2,1,nu), raman(2,2,nu),raman(2,3,nu)
       write (6,'(a,3f15.4)') "Raman z: ", raman(3,1,nu), raman(3,2,nu),raman(3,3,nu)
